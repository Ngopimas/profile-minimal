...
description: "A Hermes Agent research loop that screens European equities, backtests strategy hypotheses with costs, and runs a final gate before any paper rebalance - leaving an inspectable evidence trail at every stage."
...
role: "Solo builder"
status: "Exploratory"
impact: "Caught a dispatch bug producing clone-like backtests, refused strategies its engine couldn't test honestly, and held calculated orders when the active strategy breached its drawdown limit."
url: ""
repository: ""
ogImage: "/assets/images/project-thumbs/pea-agent-log-preview.png"
---

I designed and built an autonomous European-equity research prototype with Hermes Agent, a self-hosted AI agent with a built-in learning loop.
...
I fixed the dispatch bug, then added batch diagnostics to flag clone-like results after every run.
