...
// Game data
let phase = gameStatus.waiting; // waiting | stretching | turning | walking | transitioning | falling
...
function animate(timestamp) {
  ...
  switch (phase) {
    ...
    case gameStatus.stretching: {
      sticks.last().length += (timestamp - lastTimestamp) / stretchingSpeed;
      break;
    }
    case gameStatus.turning: {
      ...
      if (sticks.last().rotation > 90) {
        ...
        phase = gameStatus.walking;
      }
      break;
    }
    case gameStatus.walking: {
      ...
      if (nextPlatform) {
        ...
        if (heroX > maxHeroX) {
          heroX = maxHeroX;
          phase = gameStatus.transitioning;
        }
      } else {
